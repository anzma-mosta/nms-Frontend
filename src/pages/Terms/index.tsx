  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-4 py-24 max-w-4xl">
        <Reveal>
          <h1 className="text-4xl font-bold mb-8">{isAr ? "الشروط والأحكام" : "Terms & Conditions"}</h1>
        </Reveal>
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          <Reveal delay={0.1}>
            <section>
              <h2 className="text-2xl font-bold mb-4">{isAr ? "1. قبول الشروط" : "1. Acceptance of Terms"}</h2>
          ...
          <Reveal delay={0.2}>
            <section>
              <h2 className="text-2xl font-bold mb-4">{isAr ? "2. حساب المستخدم" : "2. User Account"}</h2>
              <p className="text-muted-foreground leading-relaxed">
                {isAr 
