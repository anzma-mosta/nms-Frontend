              ...
              <div className="hidden md:flex items-center gap-2 mr-4">
                <div className="text-right">
                  <p className="text-[10px] text-muted-foreground uppercase font-bold">
                    {t("lesson.progress") || "Your Progress"}
                  </p>
              ...
              {!currentLesson.isPreview && !course.isPurchased && (
                <div className="absolute inset-0 bg-slate-950/90 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center z-20">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-2">
                    {t("lesson.locked_title") || "This lesson is locked"}
                  </h2>
                  <p className="text-slate-400 max-w-md mb-8">
                    {t("lesson.locked_desc") ||
                      "Please enroll in the course to get access to all lessons and materials."}
                  </p>
              ...
              <div className="border-b mb-8 flex items-center gap-8 overflow-x-auto no-scrollbar">
                {(
                  [
                    {
                      id: "overview",
                      label: t("lesson.overview") || "Overview",
                      icon: Info,
                    },
                    {
                      id: "resources",
                      label: t("lesson.resources") || "Resources",
                      icon: FileText,
                    },
                    {
                      id: "discussions",
                      label: t("lesson.discussions") || "Discussions",
                      icon: MessageCircle,
                    },
                  ] as const
                ).map((tab) => (
                  ...
                  {activeTab === "overview" && (
                    <div className="prose dark:prose-invert max-w-none">
                      <h3 className="text-xl font-bold mb-4">
                        {t("lesson.about_lesson") || "About this lesson"}
                      </h3>
                  ...
                  {activeTab === "resources" && (
                    <div className="space-y-4">
                      ...
                      {[
                        ...
                        <div
                          key={i}
                          className="flex items-center justify-between p-4 rounded-xl border bg-white dark:bg-slate-900 hover:border-primary/50 transition-colors group"
                        >
                          <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex justify-end mt-2">
                            <Button size="sm">
                              {t("lesson.post_comment") || "Post Comment"}
                            </Button>
                          </div>
                        </div>
                      </div>
                            ...
                            <div className="flex-1">
                              <div className="bg-white dark:bg-slate-900 border rounded-2xl p-4">
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                  This lesson was very helpful! I have a
                                  question regarding the second part of the
                                  implementation...
                                </p>
                              </div>
                              <button className="text-xs text-primary font-bold mt-2 ml-2 hover:underline">
                                Reply
                              </button>
                            </div>
                          </div>
                ...
                <div className="p-6 border-b flex items-center justify-between">
                  <div>
                    <h2 className="font-bold text-lg">
                      {t("lesson.course_content") || "Course Content"}
                    </h2>
                    <p className="text-xs text-muted-foreground mt-1">
                      {navigation.total} Lessons • {course.duration}
                    </p>
                  </div>
                  <Button
                    size="icon"
                    ...
                    (section: CurriculumSection, idx: number) => (
                      ...
                      >
                        <div className="p-4 bg-slate-50 dark:bg-slate-800/50 flex items-center justify-between group">
                          ...
                          <span className="text-[10px] font-bold bg-white dark:bg-slate-900 px-2 py-0.5 rounded-full border shadow-sm">
                              ...
                              >
                                {!lesson.isPreview && !course.isPurchased ? (
                                  ...
                                  <Play
                                    className={cn(
                                      "w-3.5 h-3.5",
                                      lesson.id === lessonId && "fill-current"
                                    )}
                                  />
                                )}
                              </div>
                ...
                {!course.isPurchased && (
                  <div className="p-6 border-t dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
                    <p className="text-xs text-center text-muted-foreground mb-4">
                      Enroll to unlock 85% more content
                    </p>
